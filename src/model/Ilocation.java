...
public interface Ilocation {
  ...
  /**
   * Sets the isVisited location parameters when player moves to a new location.
   */
  public void setIsVisitedTrue();

  /**
   * This method is to get the isVisited parameter of the location to check if it is visited.
   * @return if location is visited or not
   */
