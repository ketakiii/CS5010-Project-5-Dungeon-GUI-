...
public interface IgameState {
  ...
  /**
   * Returns a list of player's locations.
   * @return list of locations
   */
  public List<Ilocation> getPlayerLocations();

  /**
   * For checking if the game is setup properly.
   * @return boolean
   */
  ...
  /**
   * Tells us the last player whose turn it was.
   * @return player
   */
  public int getLastPlayerTurn();

  /**
   * Gives the list of players playing the game.
   * @return list of players
   */
  public Iplayer[] getPlayers();

  /**
   * Gives the message if monster is hit or not.
   * @return message
   */
  public String getMonsterMessage();

  /**
   * Sets the message if monster hit or not.
   * @param s string
   */
